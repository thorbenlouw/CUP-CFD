...
#define BOOST_TEST_MODULE ExchangePatternOneSidedNonBlocking
...
BOOST_AUTO_TEST_CASE(init_test1)
{
    ...
    cupcfd::comm::ExchangePatternOneSidedNonBlocking<int> pattern;
...
// Init Driver Error Condition Checks
