...
BOOST_AUTO_TEST_CASE(merge_sort_1_test5) {
  ...
  int arr1_cmp[15] = {2,  3,  7,  9,  10, 12,  13,  15,
                      16, 19, 21, 27, 43, 142, 2003};
...
BOOST_AUTO_TEST_CASE(merge_sort_1_test6) {
  ...
  int arr1_cmp[15] = {2,  2,  3,  7,  9,   10,   10,  13,
                      15, 19, 27, 43, 142, 2003, 2003};
...
BOOST_AUTO_TEST_CASE(sourceIndexReorder_test1) {
  ...
  BOOST_CHECK_EQUAL_COLLECTIONS(testData, testData + 5, testDataCmp,
                                testDataCmp + 5);
}
