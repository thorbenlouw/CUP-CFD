...
// Test 2: Check that the function runs to completion without error when there
// are no unique elements
...
// Test 3: Check that the result is correct when the entire source is unique
// elements
...
// Test 4: Check that the result is correct when only the first element is
// unique
...
// Test 6: Check that the result is correct when the last two elements are
// unique
...
// Test 1: Find Array of Distinct Elements with correct number of instances of
// each element
...
// Test 2: Find Array of Distinct Elements with correct number of instances of
// each element with no unique elements
...
// Test 3: Find Array of Distinct Elements with correct number of instances of
// each element with all unique elements
...
// Test 4: Find Array of Distinct Elements with correct number of instances of
// each element when only first is unique
...
// Test 5: Find Array of Distinct Elements with correct number of instances of
// each element when only last is unique
...
// Test 6: Find Array of Distinct Elements with correct number of instances of
// each element when only first two are unique
...
// Test 7: Find Array of Distinct Elements with correct number of instances of
// each element when only last tow are unique
...
// Test 1: Get correct number of elements left in minus array when first array
// is larger
...
// Test 2: Get correct number of elements left in minus array when second array
// is larger
...
// Test 3: Get correct number of elements left in minus array when first array
// is all same element
...
// Test 4: Get correct number of elements left in minus array when arrays are
// the same
