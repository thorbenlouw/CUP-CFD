...
BOOST_AUTO_TEST_CASE(existsEdge_test1)
{
	...
	BOOST_CHECK_EQUAL_COLLECTIONS(&(graph.xadj[0]), &(graph.xadj[0]) + 3, localNodeCmp, localNodeCmp + 3);
	BOOST_CHECK_EQUAL_COLLECTIONS(&(graph.adjncy[0]), &(graph.adjncy[0]) + 1, adjNodeCmp, adjNodeCmp + 1);
