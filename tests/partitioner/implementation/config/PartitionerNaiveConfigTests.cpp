 ...
 * @section DESCRIPTION
 *
 * Tests for the concrete methods of the PartitionerNaiveConfig class.
 */
...
{
	PartitionerNaiveConfig<int,int> config;
}
...
// Test 2: Build a partitioner and use it to partitioner a graph
BOOST_AUTO_TEST_CASE(buildPartitioner_test2, * utf::tolerance(0.00001))
{
